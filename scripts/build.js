...
for(const file of ['index.html','style.css','icon.svg','app.js','model.js','paint.js','export.js','example.js','import.js','import-worker.js'])fs.copyFileSync(path.join(root,file),path.join(out,file));
